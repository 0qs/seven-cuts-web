    ...
    <section className="relative min-h-svh flex flex-col justify-center px-6 md:px-12 lg:px-20 pt-28 pb-20 overflow-hidden bg-[#080808]">
      ...
      <div className="relative z-10 max-w-5xl mx-auto w-full space-y-8 text-center">
        <motion.div
          ...
          className="space-y-8"
        >
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-white leading-[1.05] sm:leading-[1.02]">
            <span className="block whitespace-nowrap">World-Class</span>
            <span className="block whitespace-nowrap">Marketing Services.</span>
            <span className="block whitespace-nowrap text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-purple-500">
              Trusted Growth Partner.
            </span>
          </h1>

          <p className="text-lg md:text-xl text-zinc-400 max-w-xl mx-auto leading-relaxed">
            Driving organic growth and viral success through high-retention short form video.
          </p>
